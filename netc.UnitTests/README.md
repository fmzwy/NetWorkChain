...
This project is a work in progress, aiming to provide unit test coverage for the core NETC code.
...
OR
With .NET Core SDK installed, use the CLI to navigate to the netc.UnitTest folder and use the command 'dotnet restore' to get packages, followed by 'dotnet test' to run tests.
